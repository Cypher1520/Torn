...
(function () {
  ...
  function shouldHide(filterOptions, player) {
    return (
      (filterOptions.okayOnly && statusOf(player) !== "Okay") ||
  ...
  function getFilterOptionsFromPanel() {
    ...
    return {
      maxLevel:
        maxLevelInput &&
        !isNaN(maxLevelInput.value) &&
        parseInt(maxLevelInput.value, 10),
  ...
  function createFilterOptionsPanel() {
    ...
    competitionBr.parentNode.insertBefore(
      filterOptionsPanel,
      competitionBr.nextSibling
    );
